...
public class roa extends javax.swing.JFrame {
    ...
    public roa() {
     ...
     public void displayUser(){
        ...
        try{            
            try (ResultSet resultSet = connector.getData("SELECT r_tcustomers, r_tpets, r_tadopted FROM tbl_report")) {
                roatable.setModel(DbUtils.resultSetToTableModel(resultSet));
            }
    ...
    private void initComponents() {
        ...
        roatable = new javax.swing.JTable();
        ...
        roatable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane2.setViewportView(roatable);

        jPanel3.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 620, 370));

        jPanel1.add(jPanel3);
        jPanel3.setBounds(10, 50, 640, 390);
    ...
    private javax.swing.JTable roatable;
