 ...
 * @author DERECHO
 */
public class adminarchieve extends javax.swing.JFrame {

    /**
     * Creates new form adminarchieve
     */
    public adminarchieve() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(0, 32, 660, 410);

        jLabel1.setFont(new java.awt.Font("Candara", 1, 14)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Archive");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(290, 0, 70, 30);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminarchieve.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adminarchieve().setVisible(true);
            }
        });
    }
